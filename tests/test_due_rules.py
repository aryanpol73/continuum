...
from src.continuum.engine.due_rules import check_followup_overdue, check_refill_gap


def test_followup_overdue_within_grace():
    # Due 5 days ago, grace period is 7 days -> NOT overdue yet
    visit = MagicMock()
...
def test_refill_exhaustion_within_grace():
    ...
    # Days since supply end = 4 days <= 7 grace
    is_gap, days_remaining = check_refill_gap(rx, anchor_date=today, buffer_days=7)
